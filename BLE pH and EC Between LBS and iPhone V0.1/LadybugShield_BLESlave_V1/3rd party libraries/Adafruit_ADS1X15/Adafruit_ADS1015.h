...
protected:
 ...
 public:
  ...
  int16_t   readADC_Differential_VGND(int P);
  void      startComparator_SingleEnded(uint8_t channel, int16_t threshold);  //Added my Margaret Johnson on 12/09/2014 - see .cpp file
